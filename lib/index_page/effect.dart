...
Effect<IndexState> buildEffect() {
  return combineEffects(<Object, Effect<IndexState>>{
    ...
    IndexAction.refreshHomeData:_refreshHomeData
  });
}

void _refreshHomeData(Action action ,Context<IndexState> ctx){
   getLatestDiary(ctx);
}
...
void getLatestDiary(Context<IndexState> ctx) async{
